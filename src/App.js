...
export default function App() {
  ...
  //   setTonnage((grandTotalHeatLoad() / 3.5 / 1000));
  //   // return grandTotalHeatLoad() / 3.5 / 1000;
  // };
  const calculateTonnage = () => {
    const tonnageValue = grandTotalHeatLoad() / 3.5 / 1000;
    const formattedTonnage = tonnageValue.toFixed(3);
    setTonnage(parseFloat(formattedTonnage));
  };
  ...
  return (
    <div className="App">
      ...
      <button onClick={handleModal} style={{ position: 'relative', right: 0, top: 0 }}>
    How to use?
  </button>
      ...
      <main>
        <form onSubmit={handleSubmit}>
          <p textAlign><b>Note: Length is in meters and temperature in ºC</b></p>
          <label>
          ...
          <label>
            ...
            >
              ...
              <option value="3.2">Concrete</option>
              <option value="0.4">Plaster</option>
              <option value="0.149">asbestos</option>
            </select>
  ...
  <>
    ...
    <Modal>
      <h2 style={{ textAlign: "center" }}>Total AC Tonnage Required</h2>
      <h3 style={{ textAlign: "center" }}>{tonnage.toFixed(3)} TR</h3>
      <button onClick={handleModal}>Continue</button>
    </Modal>
  </>
)}
